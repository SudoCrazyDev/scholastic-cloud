...
- title <= 255 chars
- description should provide context relevant to Philippine students
...
- learning_objectives: array of 3-4 objective strings
- subject_matter: object with { topic, materials: array, references: array }
- procedure: object with { introduction, presentation, guided_practice, independent_practice, generalization }
  - Each procedure section has time_minutes (number) and activity-specific fields
- evaluation: object with { type, items: array of question objects with question/choices/answer }
- assignment: string
