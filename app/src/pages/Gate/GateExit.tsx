      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center text-white">
        <div className="text-center">
          ...
          <p className="text-gray-400">
            Please provide <code className="text-rose-400 bg-gray-800 px-2 py-0.5 rounded">institution_id</code> as a URL parameter.
          </p>
          <p className="text-gray-500 text-sm mt-4">
            Example: /gate-exit?institution_id=your-institution-uuid
          </p>
        </div>
      </div>
    );
