            ...
            {students.map((student, index) => (
              <motion.tr
                ...
                className={`group transition-colors ${
                  isSelected(student) ? 'bg-primary-50' : 'hover:bg-gray-50'
                }`}
              >
                {/* Checkbox */}
                ...
                <td className="px-4 py-2">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-primary-100 flex-shrink-0 relative flex items-center justify-center overflow-hidden">
