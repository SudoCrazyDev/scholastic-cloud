            ...
            <div className="relative">
              ...
              <div className="flex justify-center mt-4 space-x-2">
                <label className="cursor-pointer">
                  ...
                  />
                  <div className="flex items-center px-3 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors text-sm">
          ...
          <div key={key} className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            >
              <div className="flex items-center gap-3">
                <IdentificationIcon className="w-5 h-5 text-primary-500 shrink-0" />
                    ...
                    <div
                      className={`flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed rounded-lg transition-colors text-sm
                        ${uploading
                          ...
                          : 'border-primary-300 text-primary-600 hover:border-primary-400 hover:bg-primary-50'
                        }`}
                    >
                      {uploading ? (
                        <>
